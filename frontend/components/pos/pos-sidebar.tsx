...
const posMenuGroups = [
  ...
  {
    label: "Customers",
    items: [{ title: "Search", icon: Users, href: "/pos/customers" }],
  },
  {
    label: "Promotions",
    items: [{ title: "Discounts", icon: Percent, href: "/pos/discounts" }],
  },
];
      ...
      <SidebarContent className="px-2">
        ...
        <div className="group-data-[collapsible=icon]:hidden mt-2 p-3 bg-linear-to-br from-primary/10 via-primary/5 to-transparent rounded-xl border border-primary/20 shadow-sm relative overflow-hidden">
          ...
          <div className="flex flex-col gap-1 relative z-10">
            <span className="font-bold text-xs tracking-wide leading-none text-primary uppercase">
              {terminalName}
            </span>
                    ...
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton
                        ...
                        className={cn(
                          ...
                          isActive &&
                            "bg-sidebar-accent shadow-md font-semibold",
                        )}
                      >
                        <Link href={item.href}>
                          <Icon
