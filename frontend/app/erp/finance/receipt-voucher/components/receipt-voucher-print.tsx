      ...
      <table className="w-full text-[9px] sm:text-[10px] border-collapse table-fixed">
        <thead>
          <tr className="border-y-2 border-black">
            <th className="py-0.5 pr-1 text-left font-bold w-[38%]">
              Account Code/Description
            </th>
            <th className="py-0.5 pr-1 text-left font-bold w-[28%]">
              Naration
            </th>
            <th className="py-0.5 pr-1 text-right font-bold w-[10%]">
              Taxable
            </th>
              ...
              >
                <td className="py-px pr-1 overflow-hidden text-ellipsis">
                  <div className="flex gap-1 sm:gap-2">
                    <span className="w-12 sm:w-16 shrink-0 font-bold">
                      {d.accountCode}
                    </span>
                  ...
                  {(d.tagAccountCode || d.tagAccountName) && (
                    <div className="flex gap-1 sm:gap-2 mt-px">
                      <span className="w-12 sm:w-16 shrink-0 font-medium text-gray-700">
                        {d.tagAccountCode}
                      </span>
                ...
                <td className="py-px text-right tabular-nums"></td>
              </tr>
            );
          })}
          ...
          {creditRows.map((d, i) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-px pr-1 text-right tabular-nums"></td>
      ...
      <div className="w-full border-t-2 border-black mt-0">
        <div className="flex items-start">
          ...
          <div className="w-[12%] py-px pr-1 text-right">
            <div
              className="border-t border-black pb-px"
              style={{ borderBottom: "3px double black" }}
            >
              <span className="tabular-nums text-[9px] sm:text-[10px] block pt-px font-bold">
                {fmt(totalDebit)}
              </span>
            </div>
          </div>
