          ...
          <div className="flex items-center gap-2">
            ...
            {(invoice.status === "POSTED" || invoice.status === "PARTIAL") && (
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/erp/finance/receipt-voucher/create?customerId=${invoice.customerId}&invoiceId=${invoice.id}`,
                  )
                }
              >
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div>
                  ...
                  {invoice.salesOrder?.orderNo || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Delivery Challan:</span>{" "}
                  {invoice.deliveryChallan?.challanNo || "N/A"}
                </div>
                <div>
                  <span className="font-medium">Status:</span>
                  <Badge
                    className={`ml-2 ${getStatusColor(invoice.status || "PENDING")}`}
                  >
                    {invoice.status || "PENDING"}
                  </Badge>
                </div>
        ...
        <div className="w-full max-w-[1000px] mx-auto bg-white text-black p-8 font-sans print:p-8 print:max-w-none box-border">
          ...
          <div className="flex gap-4 mb-4 text-xs sm:text-[13px]">
            <div className="w-full p-2 border border-gray-300 flex flex-col justify-center">
              ...
              {invoice.customer?.phone && (
                <div className="flex gap-2 mb-1">
                  <span className="font-bold w-16 shrink-0">Phone:</span>{" "}
          ...
          <div className="flex border-b border-black pb-2 items-end">
            <div className="w-[55%] pt-4">
              <div className="flex gap-2 font-bold text-xs sm:text-[13px]">
                ...
                <span className="underline decoration-1 underline-offset-2 break-words">
                  {numberToWords(Number(invoice.grandTotal || 0))}
                </span>
              </div>
            </div>
            ...
            <div className="w-[20%] text-right">
              ...
              <div className="tabular-nums text-xs sm:text-[13px] text-gray-700">
                {fmt(Number(invoice.taxAmount || 0))}
              </div>
              <div className="tabular-nums text-xs sm:text-[13px] text-gray-700">
                -{fmt(Number(invoice.discount || 0))}
              </div>
              <div
